...
public class SoxAtkJiggleBone : MonoBehaviour {
    ...
    public void JiggleBoneUpdate()
    {
        ...
        float deltaTime = Time.smoothDeltaTime * m_simulationSpeed;;
        switch (m_simType)
        {
            ...
            case SimType.Simple:
                ...
                m_resultVec = (m_forceVec * m_tensionProxy * deltaTime) + m_beforeInerciaVec * (Mathf.Lerp(m_inercia, 0.0f, deltaTime));
                // Gravity
                m_resultVec += m_gravity * deltaTime;
