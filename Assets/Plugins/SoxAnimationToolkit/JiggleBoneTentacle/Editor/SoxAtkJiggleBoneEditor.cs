...
public class SoxAtkJiggleBoneEditor : Editor
{
    ...
    SerializedProperty ms_simulationSpeed;
    ...
    void OnEnable()
    {
        ...
        ms_simulationSpeed = serializedObject.FindProperty("m_simulationSpeed");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(ms_simulationSpeed, new GUIContent("Simulation speed"));
