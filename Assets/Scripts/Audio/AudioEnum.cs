...
public static class SFXFiles {
    ...
    public static string wind_fall = "Wind_fall";
    ...
    public static string ui_button_hover = "Ui_button_hover";
    public static string ui_button_unhover = "Ui_button_unhover";
    public static string pause_show = "Pause_show";
    public static string pause_hide = "Pause_hide";
